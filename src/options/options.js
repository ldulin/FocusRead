  ...
  var SCHEMA = [
    {
      ...
      groups: [{
        ...
        title: 'Turning on',
        fields: [
          { key: 'autoActivate', type: 'checkbox', label: 'Start automatically everywhere',
          ...
          { key: 'autoActivateHosts', type: 'list', label: 'Start automatically on these sites',
    ...
    },
    {
      ...
      groups: [{
        ...
        fields: [
          ...
          { key: 'pdfInterceptLinks', type: 'pdfIntercept', label: 'Open PDF links in FocusRead',
  ...
  function render() {
    ...
    SCHEMA.forEach(function (t, i) {
      ...
      t.groups.forEach(function (g) {
        ...
        g.fields.forEach(function (f) { box.appendChild(makeField(f)); });
